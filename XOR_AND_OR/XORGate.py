...
def main():
    ...
    for _ in range(noEpochs):
        ...
        d_predicted_output = bkProp_error * HyperbolicDerivative(predicted_output)
        ...
        d_hidden_layer = error_hidden_layer * HyperbolicDerivative(hidden_layer_output)
