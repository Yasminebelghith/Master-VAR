...
def summarizeLearningCurvesPerformances(histories, scores):
    ...
    for i in range(len(histories)):
        ...
        pyplot.plot(histories[i].history['val_accuracy'], color='red', label='validation')
...
def defineModel(input_shape, num_classes):
    ...
    model.add(Conv2D(64, (3, 3), input_shape=input_shape, activation='relu', kernel_initializer='he_uniform', padding='same'))
    model.add(Conv2D(64, (3, 3), input_shape=input_shape, activation='relu', kernel_initializer='he_uniform', padding='same'))
    model.add(Conv2D(128, (3, 3), input_shape=input_shape, activation='relu', kernel_initializer='he_uniform', padding='same'))
